...
if labels[result]=="Flooding":
    client = Client('AC04f915dd142ca69adbcaf13d17bf6711', '2c3daeabef560f314369d8dffd602b29')
    message=client.messages.create(from_='+16815223569',
                       to='+919746343019',
                       body='Emergency alert! Flash flood warning issued. (Map location) . Floodline 049500000, quick Dial 93629. Call 1234 if you are in immidiate danger')
    print(message)
